...
namespace mogo
{
    ...
    struct _SEntityDefProperties
    {
        ...
        bool m_bCellData;       //跨cellApp进程时是否打包
    ...
    class CDefParser
    {
        ...
        public:
            //计算所有def文件的混合签名
            string CalcMd5OfAll(const char* pszDefFilePath);
        ...
        private:
            ...
            //计算签名
            void CalcMd5(const string entityName, const char* pszFile);
        private:
            void InitData();
        ...
        public:
			...
			inline const SDBCfg& GetLogDbCfg() const
			{
				return m_logDbCfg;
			}
			inline const SRedisCfg& GetRedisCfg() const
			{
				return m_redisCfg;
			}
        public:
            ...
            inline const string& GetEntityDefMd5() const
            {
                return m_EntityDefMd5;
            }
        private:
            ...
            SDBCfg m_dbCfg;
            SDBCfg m_logDbCfg;
			SRedisCfg m_redisCfg;
            map<string, int> m_typeStr2CalcMd5;
            CMd5 m_md5;
            string m_EntityDefMd5;
    };
